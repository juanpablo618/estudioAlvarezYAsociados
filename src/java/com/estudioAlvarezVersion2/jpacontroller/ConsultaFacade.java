...
public class ConsultaFacade extends AbstractFacade<Consulta> {
    ...
    private List<Predicate> buildPredicates(Map<String, Object> filters, CriteriaBuilder cb, Root<Consulta> root) {
        ...
        if (fechaFilter != null && !fechaFilter.toString().isBlank()) {
        ...
        if (equipoFilter != null && !equipoFilter.toString().isBlank()) {
        ...
        if (telefonoFilter != null && !telefonoFilter.toString().isBlank()) {
        ...
        if (procedenciaFilter != null && !procedenciaFilter.toString().isBlank()) {
        ...
        if (estadoFilter != null && !estadoFilter.toString().isBlank()) {
