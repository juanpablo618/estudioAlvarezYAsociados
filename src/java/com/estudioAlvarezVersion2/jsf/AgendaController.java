...
public class AgendaController implements Serializable {
    ...
    private static final List<String> SUGERENCIAS_DESCRIPCION_AGENDA = Arrays.asList(
        ...
        "Ver nueva consulta",
        "Solicitar blanqueo de clave ss",
        "Ver si se blanqueo clave + agendar para ver consulta",
        "Controlar si dimos respuesta a esta nueva consulta",
        "Saludar por cumpleaños",
        "Consultar socioeconómico",
        "Sacar turno ANSES",
        "Completar formularios + convenio",
        "Citar para certificar formularios, convenio y dni",
        "Preparar este trámite con turno en ANSES",
        "Controlar este trámite con turno en ANSES",
        "Dejar listo trámite con turno en ANSES",
        "Avisar trámite ingresado en ANSES ok",
        "Expediente ingresado en ANSES, ver si se resolvió si no agendar para reclamar agilización",
        "Citados, consultar en ANSES motivos",
        "Citados, verificar si cumplimentamos si no agilizar",
        "Avisar expediente resuelto favorable + fecha primer cobro",
        "Controlar liquidación previsional de este mes + coordinar cobro",
        "Recordar mañana primer cobro",
        "Ver si cobro ok este mes + pago honorarios  y si esta terminado para dar de baja legajo",
        "Ver si hizo entrega de honorarios pendientes si no recordar",
        "Dar de baja legajo",
        "Ver si se contactó para generar VEP si no enviar mensaje con valor actualizado",
        "Generar VEP",
        "Ver si pago VEP generado, si no recordar",
        "Hacer hoja de vista + agendar para pedir en ANSES",
        "Pedir vista en ANSES",
        "Abonar boleta de aportes + escanear, subir a sistema y agendar para presentar en justicia federal",
        "Verificar si recibieron en Cámara por nuestra apelación y dictaron decreto para expresar agravios, sino para reclamar.",
        "Verificar si recibieron en Cámara por apelación ANSES y dictaron decreto para expresar agravios, sino para reclamar.",
        "Verificar si recibieron en Cámara y dictaron decreto autos, sino para reclamar.",
        "Verificar si volvió con vista fiscal y dictaron decreto autos sino para reclamar.",
        "Expresar agravios Not. 23/8",
        "Verificar si ANSES expresó agravios sino solicitar deserción",
        "Contestar agravios",
        "Verificar si Jose/Eze/Car expresó agravios sino recordar que mañana vence plazo.",
        "Verificar si Jose/Eze/Car contestó agravios sino recordar que mañana vence plazo.",
        "Verificar si ANSES contestó agravios sino solicitar decaimiento y pase a resolver",
        "Verificar si AFIP interpuso REX sino hacer escrito solicitando remisión a JF.",
        "Verificar si ANSES interpuso REX sino hacer escrito solicitando remisión a JF.",
        "Verificar si remitieron de Cámara a JF, por rechazo REX sino hacer escrito solicitando.",
        "Verificar si tuvimos novedades de sentencia Cámara sino para empezar a reclamar- Autos .",
        "Verificar si tuvimos novedades de sentencia REX sino para empezar a reclamar- Autos .",
        "Anotar que salió sentencia rechazando REX, impusieron costas a ANSES y difirieron regulación",
        "Anotar que salió sentencia, impusieron costas a ANSES y regularon el 35%",
        "Avisar a cliente que salió sentencia de Cámara favorable pero debemos esperar si ANSES interpone REX + explicar pasos a seguir+ anotar en comunciaciones",
        "Avisar a cliente que salió sentencia rechazo REX + explicar pasos a seguir",
        "Ver si Jose ya contestó impugnación y presentamos sino recordar mañana vence",
        "Ver si Cami ya contestó impugnación y presentamos sino recordar mañana vence",
        "Ver si S ya contestó impugnación y presentamos sino recordar mañana vence",
        "Ver si S expresó agravios y presentamos sino recordar mañana vence",
        "Ver si Jo expresó agravios y presentamos sino recordar mañana vence",
        "Ver si Cami expresó agravios y presentamos sino recordar mañana vence",
        "Ver si S contestó agravios y presentamos sino recordar mañana vence",
        "Ver si Jo contestó agravios y presentamos sino recordar mañana vence",
        "Ver si Cami contestó agravios y presentamos sino recordar mañana vence",
        "Ver si proveyeron escrito donde solicitamos decaimiento y pase a resolver sentencia primera instancia sino para reclamar- subido 21/10",
        "Ver como viene con alegatos sino para acelerar",
        "Ver si proveyeron escrito donde solicitamos pase a resolver sino para reclamar. Subido el 22/10",
        "Ver si proveyeron escrito donde solicitamos decaimiento alegatos y si pasó a resolver sentencia primera instancia sino para reclamar en JF3",
        "Ve si ANSES presentó alegatos sino solicitar decaimiento y pase a resolver",
        "Ver si proveyeron denuncia cobro honorarios sino para reclamar. Subido el 5/2",
        "Controlar si dimos ya la devolución a esta consulta.",
        "Citar para firmar, demanda + recordar pedir dinero de poder y aportes+ en caso de que no este digitalizado recordar que traiga DNI+ hacer agenda turno chicos para imprimir demanda y un día despues para ver si pasó a firmar",
        "Contactar a Sr. y ofrecer nueva dda movilidad, explicar que es juicio nuevo + si está de acuerdo dar de alta nuevo legajo +agendar para hacer dda",
        "Verificar si volvió deox apertura cta. sino para ver si reiteramos pedidos.",
        "Denunciar cobro honorarios y actualizar.",
        "Verificar si ANSES impugnó planilla sino solicitar aprueben y pase a resolver.",
        "Verificar si tuvimos novedades de sentencia de regulación sino para empezar a reclamar. Autos",
        "Verificar si AFIP acompañó planilla cuantificando capital + intereses + honorarios sino para solicitar nuevo emplazamiento bajo apercibimiento astreintes heavy",
        "Ver si volvió deox denunciar cobro y actualizar.",
        "Verificar si se hizo efectiva transferencia, agendar denunciar cobro y actualizar deuda + ver si volvió deox para pasar",
        "Verificar si AFIP manifestó algo de traslado formularios circuito de pago sino solicitar emplacen",
        "Verificar si quedan diferencias de honorarios, denunciar cobro",
        "Verificar si está liquidada sentencia pasar detalles a excel + agendar para avisar y coordinar cobro",
        "Dar seguimiento a al expdte. en CSJN por REX admitido parcialmente para ver como va circulando.",
        "Avisar a cliente que se admitio parcialmente el REX interpuesto por ANSES sobre movilidad Fernandez Pastor. Ser lo mas claros posibles al explicar. El resto de los puntos quedo firme y favorable a él por ende cumplido el plazo podemos ir ejecutando parcialmente, le vamos a ir avisando pero no podemos asegurar tiempos.",
        "Hoy se cumple plazo de 120 días desde sentencia REX, ver si ya salió fallo CSJN o si iniciamos ejecución parcial.",
        "Pedir embargo."
    );
